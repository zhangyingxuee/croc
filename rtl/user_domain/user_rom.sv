...
module user_rom #(
  ...
  always_comb begin
    ...
    if(req_q) begin
      if(~we_q) begin
        case(word_addr)
          //2'h0: rsp_data = 32'h0000 0041;
          2'h0: rsp_data = 32'h2659_4357;
          2'h1: rsp_data = 32'h2758_595a;
          2'h2: rsp_data = 32'h5341_2073;
          2'h3: rsp_data = 32'h0000_4349;
          // 3'h4: rsp_data = 32'h2073;
          // 3'h5: rsp_data = 32'h5341;
          // 3'h6: rsp_data = 32'h4349;
          // 3'h7: rsp_data = 32'h305c;
